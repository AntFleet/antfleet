/**
 * One-off — apply migration 0010 directly when older pending migrations
 * block drizzle-kit's migration runner.
 *
 * Usage (from apps/web):
 *   pnpm exec tsx scripts/apply-migration-0010.ts            # dry-run
 *   pnpm exec tsx scripts/apply-migration-0010.ts --apply    # mutate
 */
