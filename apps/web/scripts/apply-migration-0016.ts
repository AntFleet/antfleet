/**
 * One-off — apply migration 0016 (GitHub App installation approval gate).
 *
 * Usage (from apps/web):
 *   pnpm exec tsx scripts/apply-migration-0016.ts            # dry-run
 *   pnpm exec tsx scripts/apply-migration-0016.ts --apply    # mutate
 */
...
async function main() {
  ...
  try {
    ...
    console.log(`[installations] exists=${existence}`);
