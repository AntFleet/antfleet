#!/usr/bin/env tsx
// Apply migration 0056 (agent_findings verification provenance) to the DB.
// Usage: pnpm exec tsx scripts/apply-migration-0056.ts [--apply]
...
const sqlFile = readFileSync(
  join(selfDir, "../db/migrations/0056_agent_finding_verification.sql"),
  "utf-8",
);
